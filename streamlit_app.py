...
def introduction_page():
    ...
    st.write('''This app explores the relationship between various lifestyle factors and sleep quality using three datasets:
                ...
                showcasing complex visualizations to highlight correlations and patterns in the data.''')

# Hypothesis 1: Caffeine and Alcohol impact on Sleep Efficiency (with 4 visualizations)
def page_one():
